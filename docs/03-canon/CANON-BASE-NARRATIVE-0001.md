...
INPUTS: [CANON-BASE-RULE-0001, CANON-2215-CORE-0001]
...
[DECISION][NAR-INV-003] При конфликте приоритет имеет CANON-BASE-RULE-0001.
...
берутся исключительно из CANON-BASE-RULE-0001.
...
~~~yaml
doc_id: CANON-BASE-NARRATIVE-0001
role_type: INTERFACE
export:
