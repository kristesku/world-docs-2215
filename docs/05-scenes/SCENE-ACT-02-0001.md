...
title: >
  SCENE-CARDS — Акт II (Главы 11–15) — логистика расширяет кейс → первичные контуры экстерриторий
class: scene
status: fixed
version: 0.1.0
...
depends_on: [SCENE-ACT-01-0001]
scope: >
  Полный комплект SCENE-CARDS для Акта II (главы 11–15): расширение кейса через логистику,
  появление институциональных границ и первых “экстерриториальных” контуров; рост ставок и наблюдаемости.
