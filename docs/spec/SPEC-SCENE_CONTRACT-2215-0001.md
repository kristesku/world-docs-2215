---
id: SPEC-SCENE_CONTRACT-2215-0001
title: >
...
[DECISION][SCN-020] Scene MUST respect global resolution order from `SPEC-PRIORITY_RESOLUTION-2215-0001`; ELSE FAIL.
...
[DECISION][SCN-072] Conflict resolution follows `SPEC-PRIORITY_RESOLUTION-2215-0001`; ELSE FAIL.

## OUTPUT CONTRACT

~~~yaml
doc_id: SPEC-SCENE_CONTRACT-2215-0001
role_type: RULE
export:
  - rule_id: SCN-030
