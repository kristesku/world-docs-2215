...
[FACT][SCA4-DEF-010] `scene_card` = record fields: scene_id, chapter_id, where, pov, goal, measurable, artifact, cmc, output, hook.
...
[DECISION][SCA4-INV-012] If `measurable` includes environment sensors, they MUST be traceable to BASELINE-PHYSICAL-LEVEL-MID-2215-0001 ranges OR explicit override.
