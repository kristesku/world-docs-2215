...
[FACT][SCA3-005] scene_id=SC-17.4; chapter_id=CH-17; time="15:30 (Afternoon)"; where="Точка выдачи / подписи"; pov="Лейсан"; goal="получение документа и его границ"; measurable="access_window=6h; no_export_without_trigger=true"; artifact="CD(warrant v2.3: TAO/ISO + список разрешенных действий)"; cmc="федерация дает доступ, но страхуется → ОСА ограничена → действовать быстро и чисто"; output="юридический мандат на вход"; hook="объект вне региона; эскорт обязателен"; tags="relief, paper, restless".
...
[FACT][SCA3-011] scene_id=SC-19.3; chapter_id=CH-19; time="21:00 (Night)"; where="Коридор / перехват"; pov="Мирон"; goal="минимальное действие: за стойки, не ради победы"; measurable="duration=50–70s; injuries=1(light); fatalities=0"; artifact="CD(coercion act)"; cmc="охрана пытается вернуть оборудование → ОСА держит периметр → данные остаются у ОСА"; output="контроль восстановлен"; hook="некоторые логи 'слишком чистые'"; tags="standoff, kinetic".
