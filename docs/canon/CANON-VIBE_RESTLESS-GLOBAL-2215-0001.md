---
id: CANON-VIBE_RESTLESS-GLOBAL-2215-0001
title: >
...
[RULE][RST-022] PASS IFF (NOT in_inputs(scene.inputs, "CANON-VIBE_RESTLESS-GLOBAL-2215-0001")) OR (scene.vibe == "RESTLESS"); ELSE FAIL.
...
[RULE][RST-130] PASS IFF (scene.vibe != "RESTLESS") OR (NOT contains(scene.directives, "USES_SYSTEM_INSERTS")) OR in_inputs(scene.inputs, "CANON-SYSTEM_VOICE-GLOBAL-2215-0001"); ELSE FAIL.
[RULE][RST-131] PASS IFF (scene.vibe != "RESTLESS") OR (NOT contains(scene.directives, "USES_ARTIFACT_SNIPPETS")) OR in_inputs(scene.inputs, "CANON-ARTIFACT_SNIPPETS-RU-2215-0001"); ELSE FAIL.
...
[DECISION][RST-201] Conflict resolution MUST follow `SPEC-PRIORITY_RESOLUTION-2215-0001`; ELSE FAIL.
...
~~~yaml
doc_id: CANON-VIBE_RESTLESS-GLOBAL-2215-0001
role_type: RULE
export:
  - rule_id: RST-022
