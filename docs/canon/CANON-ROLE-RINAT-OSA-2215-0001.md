---
id: CANON-ROLE-RINAT-OSA-2215-0001
title: >
  Роль — Ринат (ОСА) — regional chief, политическое прикрытие, рамки риска и интерфейсы (2215)
class: canon
status: draft
version: 1.0.0
prefix: ORI
...
scope: >
  RULE-канон роли Рината как руководителя регионального отдела ОСА (RU-16/CHELNY).
...
ROLE_TYPE: RULE
SCOPE: define Rinat role contract as regional chief providing political shield and administrative governance for RU-16 OSA
...
[FACT][ORI-010] `rinat` = руководитель регионального отдела ОСА в RU-16/CHELNY.
...
[DECISION][ORI-100] Ринат MUST быть `regional_chief` регионального отдела ОСА RU-16.
...
[RULE][ORI-230] IF `osa_center.request` = "tactical_micro_management" THEN `rinat.must_reject_request` MUST be true; ELSE FAIL.
...
[RULE][ORI-530] IF `external_request.received` = true THEN `jurisdiction_gate` MUST remain "OSA-300"; ELSE FAIL.
...
[DECISION][ORI-950] Любая сцена, использующая роль Рината в ОСА, MUST следовать ORI-100..ORI-720; ELSE FAIL.
[DECISION][ORI-960] Conflict resolution MUST follow SPEC-PRIORITY-RESOLUTION-2215-0001; ELSE FAIL.

## OUTPUT CONTRACT

~~~yaml
doc_id: CANON-ROLE-RINAT-OSA-2215-0001
role_type: RULE
export:
  - rule_id: ORI-230
    intent: reject tactical micro-management requests from center
    inputs: [osa_center.request]
...
[FORBIDDEN][ORI-982] Подмена юрисдикционного критерия ОСА внешним запросом/давлением; ELSE FAIL.

## NON-NORMATIVE

~~~text
Источник: ROLE-RINAT-OSA-2215-0001 (черновик).
