---
id: CANON-VIBE_VOID-GLOBAL-2215-0001
title: >
...
[DECISION][VOI-410] Conflict resolution MUST follow `SPEC-PRIORITY_RESOLUTION-2215-0001`; ELSE FAIL.
[DECISION][VOI-420] This doc MUST NOT weaken CANON-VIBE_RESTLESS-GLOBAL-2215-0001 outside scenes where `scene.vibe == "VOID"`; ELSE FAIL.

## OUTPUT CONTRACT

~~~yaml
doc_id: CANON-VIBE_VOID-GLOBAL-2215-0001
role_type: RULE
export:
  - rule_id: VOI-240
