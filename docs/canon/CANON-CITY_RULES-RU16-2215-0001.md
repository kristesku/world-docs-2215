---
id: CANON-CITY_RULES-RU16-2215-0001
title: >
...
inputs:
  - CANON-CITY_BOUNDARY-CHELNY-2215-0008
...
INPUTS: [CANON-CITY_BOUNDARY-CHELNY-2215-0008, CANON-CITY_REGISTRY-RU-2215-0001]
...
[FACT][CITYR-010] `city_chelny_2215` = функциональная городская территория Челнов-2215 внутри канонического периметра (`CANON-CITY_BOUNDARY-CHELNY-2215-0008`).
...
[FACT][CITYR-018] `anchor_tokens` = token pools exported by `CANON-CITY_REGISTRY-RU-2215-0001`.
...
[FORBIDDEN][CITYR-033] Any new boundary, corridor, or “expanded perimeter” not defined in `CANON-CITY_BOUNDARY-CHELNY-2215-0008`.
...
[RULE][CITYR-092] Boundary claims MUST be sourced only from `CANON-CITY_BOUNDARY-CHELNY-2215-0008`; ELSE FAIL.

## OUTPUT CONTRACT

~~~yaml
doc_id: CANON-CITY_RULES-RU16-2215-0001
role_type: RULE
export:
  - rule_id: CITYR-020
    intent: "forbid west-of-Kama urbanization"
    inputs: [CANON-CITY_BOUNDARY-CHELNY-2215-0008]
...
[FORBIDDEN][CITYR-900] Введение новых географических границ или “расширений периметра” вне `CANON-CITY_BOUNDARY-CHELNY-2215-0008`.
...
City anchors are optional and live as tokens in CANON-CITY_REGISTRY-RU-2215-0001.
