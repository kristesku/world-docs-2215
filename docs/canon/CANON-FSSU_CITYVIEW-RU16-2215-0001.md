---
id: CANON-FSSU_CITYVIEW-RU16-2215-0001
title: >
...
depends_on:
  ...
  - CANON-FSSU_DEPT_STRUCT-RU16-2215-0001
...
[DECISION][OCV-140] Любое действие ГОРОД-2 MUST быть ограничено whitelist REG-FSSU_AUTO_LOWIMPACT-2215-0001.
...
[RULE][OCV-420] IF `city_view_2.executes_action` = true THEN `action.type` MUST be in whitelist(REG-FSSU_AUTO_LOWIMPACT-2215-0001); ELSE FAIL.
...
[DECISION][OCV-910] Conflict resolution MUST follow SPEC-PRIORITY_RESOLUTION-2215-0001; ELSE FAIL.

## OUTPUT CONTRACT

~~~yaml
doc_id: CANON-FSSU_CITYVIEW-RU16-2215-0001
role_type: RULE
export:
  - rule_id: OCV-110
