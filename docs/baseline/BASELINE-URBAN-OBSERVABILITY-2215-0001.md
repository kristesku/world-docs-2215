---
id: BASELINE-URBAN-OBSERVABILITY-2215-0001
title: >
...
[FACT][OBS-DEF-011] urban_telemetry = автоматический сбор сигналов о присутствии,
движении и событиях в публичном пространстве.
[FACT][OBS-DEF-012] telemetry_event = атомарное событие наблюдаемости
(вход, выход, аномалия, нарушение).
...
[RULE][OBS-BSP-012] IF zone = blind_spot THEN only perimeter_events MAY be collected.
[RULE][OBS-BSP-013] IF zone = blind_spot THEN internal_presence MUST NOT be collected.
...
[RULE][OBS-PFR-011] Post_factum reconstruction MUST rely on stored telemetry_events only.
...
~~~yaml
doc_id: BASELINE-URBAN-OBSERVABILITY-2215-0001
role_type: RULE
export:
  - rule_id: OBS-SUR-010
